      ...
      >
        ...
        >
          ...
          <div>
            ...
            <Link to="/club/politicaspca" style={{ color: '#F5E8C7', fontSize: '16px', display: 'block', marginBottom: '10px', textDecoration: 'none' }}>
              <SafetyOutlined style={{ fontSize: '18px', marginRight: '5px', color: '#F5E8C7' }} /> Política de Privacidad
            </Link>
            <Link to="/club/terminospca" style={{ color: '#F5E8C7', fontSize: '16px', display: 'block', marginBottom: '10px', textDecoration: 'none' }}>
              <FileTextOutlined style={{ fontSize: '18px', marginRight: '5px', color: '#F5E8C7' }} /> Términos y Condiciones
            </Link>
            <Link to="/club/visionpca" style={{ color: '#F5E8C7', fontSize: '16px', display: 'block', marginBottom: '10px', textDecoration: 'none' }}>
              <ThunderboltOutlined style={{ fontSize: '18px', marginRight: '5px', color: '#F5E8C7' }} /> Misión
            </Link>
            <Link to="/club/misionpca" style={{ color: '#F5E8C7', fontSize: '16px', display: 'block', marginBottom: '10px', textDecoration: 'none' }}>
...
export default PieDePaginaClub;