...
const Mision = () => {
  ...
  const fetchMisiones = async () => {
    ...
    setError(null);
    try {
      const response = await axios.get('https://backendivd-mbok.onrender.com/api/mision');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingId) {
        response = await axios.put(`https://backendivd-mbok.onrender.com/api/mision/${editingId}`, payload);
        ...
        response = await axios.post('https://backendivd-mbok.onrender.com/api/mision', payload);
        MySwal.fire({
          title: '¡Éxito!',
  ...
  const handleDelete = async (id) => {
    ...
    if (result.isConfirmed) {
      setLoading(true);
      try {
        const response = await axios.delete(`https://backendivd-mbok.onrender.com/api/mision/${id}`);
